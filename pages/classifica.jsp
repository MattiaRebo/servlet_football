...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 col-lg-9 row">
            ...
            <div class="row align-left text-center menu d-flex justify-content-center justify-content-lg-start">
                <div class="col-12 col-lg-3 element"><a href="http://104.46.43.181:8080/servlet_football/competition?competition=${competitioncode}">Informazioni</a></div>
                <div class="col-12 col-lg-3 element"><a href="http://104.46.43.181:8080/servlet_football/match?matchday=${matchday}&season=${season}&competitioncode=${competitioncode}&competitions=${comp}&emblem=${emblem}">Partite</a></div>
                <div class="col-12 col-lg-3 disable"><a href="http://104.46.43.181:8080/servlet_football/standing?matchday=${matchday}&season=${season}&competitioncode=${competitioncode}&competitions=${comp}&emblem=${emblem}">Classifica</a></div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="d-flex justify-content-center row no-padding pt-4">
        ...
        <c:forEach items="${classifica}" var="squadra">
            <div class="row no-padding no-gutters riga d-flex align-items-center align-middle">
...
<script type="text/javascript">
    ...
    $("#dropdown_season").on('change', function (){
        ...
        var link = "http://104.46.43.181:8080/servlet_football/standing?matchday="+ ${matchday} +"&season="+ season +"&competitioncode=${competitioncode}&competitions=${comp}&emblem=${emblem}";
