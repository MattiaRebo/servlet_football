...
<div class="m-3">
    ...
    <div class="m-2 d-flex justify-content-around row" style="">
        <a href="http://104.46.43.181:8080/servlet_football/competition?competition=SA" class="col-12 col-md-6 col-xl-3 link-none">
        ...
        <a href="http://104.46.43.181:8080/servlet_football/competition?competition=PL" class="col-12 col-md-6 col-xl-3 link-none">
            <div class="competition col-12">
                <div class="m-2 justify-content-center">
        ...
        <a href="http://104.46.43.181:8080/servlet_football/competition?competition=FL1" class="col-12 col-md-6 col-xl-3 link-none">
            <div class="competition col-12">
                <div class="m-2 justify-content-center">
                    <div class="d-flex align-middle">
        ...
        <a href="http://104.46.43.181:8080/servlet_football/competition?competition=BL1" class="col-12 col-md-6 col-xl-3 link-none">
            <div class="competition col-12">
                <div class="m-2 justify-content-center">
                    <div class="d-flex align-middle">
    ...
    <div class="col-12 text-center" id="title">Partite del giorno [<code style="font-size: 2.3rem">${number}</code>]</div>
